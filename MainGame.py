...
from PoliticalGame import PoliticalGameSimulation

iterations = 500

# Initialization and simulation code
political_systems = ['dictatorship', 'democracy', 'democracy', 'dictatorship', 'democracy']
game = PoliticalGameSimulation(iterations, num_countries=5, num_strategies=10, num_resources=4, political_systems=political_systems)
q_values = np.random.rand(5, 10)

game.run_simulation(iterations=iterations, q_values=q_values)
